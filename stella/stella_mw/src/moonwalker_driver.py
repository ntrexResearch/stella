...
# This function calculaes the left and right velocity in the unit of rpm.
#
...
def on_new_twist(data):
    ...
    if not fault_flag:
        ...
        remote_tx_queue.put('mvc='+ str(left_speed) + ',' + str(right_speed) + '\r\n')
#remote_tx_queue.put([MD_text_command_map["dual velocity command"], left_speed, right_speed])
    else:
        # On fault, stop the robot

        remote_tx_queue.put('mvc=0,0\r\n')
#remote_tx_queue.put([MD_text_command_map["dual velocity command"], 0, 0])
